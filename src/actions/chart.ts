...
export const setChartCurrency = (currencyID: number): any => async (dispatch: TAppDispatchThunk<{
    currencyID: number
}>): Promise<void> => {
    dispatch({
...
export const getChartData = (
    ...
    fetch(`${CHART_DATA_URL}/${currencyID}?startdate=${startDate}&enddate=${endDate}`)
    .then(
        response => {
...
export const setChartData = (data: number[][]): any => async (dispatch: TAppDispatchThunk<{
    data: number[][]
}>): Promise<void> => {
    dispatch({
        type: SET_CHART_DATA,
...
export const setChartError = (error: string): any => async (dispatch: TAppDispatchThunk<{
    error: string
}>): Promise<void> => {
    dispatch({
